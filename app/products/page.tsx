...
type Product = { id: string; business_id: string; name: string; barcode: string | null; category: string | null; cost_price: number | null; sell_price: number | null; minimum_price: number | null; stock: number | null; image: string | null; created_at: string }
