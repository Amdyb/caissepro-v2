      ...
      <div className="mx-auto max-w-7xl pb-20">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <div className="mt-4 flex gap-2">
                <span
                  className={`rounded-full px-4 py-2 text-xs font-black ${business.status === 'suspended' ? 'bg-orange-100 text-orange-700' : ''}`}
                  style={business.status !== 'suspended' ? { backgroundColor: primary + '22', color: primary } : undefined}
                >
                ...
                <span className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs font-black text-slate-500">
                  <span className="h-3.5 w-3.5 rounded-full border border-slate-200" style={{ backgroundColor: primary }} title="Couleur primaire" />
                  <span className="h-3.5 w-3.5 rounded-full border border-slate-200" style={{ backgroundColor: secondary }} title="Couleur secondaire" />
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 grid gap-5 md:grid-cols-4">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-5xl font-black" style={{ color: primary }}>{activeProducts.length}</p>
          </div>
