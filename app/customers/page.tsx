...
import { ArrowLeft, Gift, Phone, Plus, Search, Star, Users } from 'lucide-react'
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-8 rounded-3xl bg-slate-50 p-5">
            ...
            <p className="text-sm text-slate-600">
              Préparez votre boutique pour les points fidélité,
              clients VIP, promotions WhatsApp et historique d’achats.
            </p>
          </div>
        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="rounded-2xl bg-slate-50 px-4 py-3 text-center">
                        ...
                        <p className="mt-1 text-lg font-black text-slate-950">
                          {Number(customer.total_spent || 0).toLocaleString('fr-FR')} CFA
                        </p>
                      </div>
                    </div>
                  </div>
