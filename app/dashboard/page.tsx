    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <h2 className="text-4xl font-black tracking-tight text-slate-950">Vue d’ensemble</h2>
            <p className="mt-2 max-w-2xl text-slate-600">
              Suivez vos ventes, votre stock et les performances de votre boutique en temps réel.
            </p>
          </div>

          <div className="flex flex-wrap gap-3">
            <Link href="/pos" className="rounded-2xl bg-brand-600 px-5 py-3 text-sm font-black text-white hover:bg-brand-700">
              Ouvrir la caisse
            </Link>
            <Link href="/products" className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-black text-slate-700 hover:bg-slate-100">
              Produits
            </Link>
            <Link href="/sales" className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-black text-slate-700 hover:bg-slate-100">
              Ventes
            </Link>
          </div>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm font-semibold text-red-600">{analytics.lowStock.length} stock bas</p>
          </div>
        </div>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-5 text-sm font-bold text-slate-500">Utilisateurs boutique</p>
              <p className="mt-2 text-3xl font-black text-slate-950">{membersCount}</p>
              <p className="mt-1 text-sm font-semibold text-slate-500">Rôles employés bientôt disponibles.</p>
            </div>
          </div>
        </div>
      </section>
